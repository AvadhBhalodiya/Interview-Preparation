...
1. [What Database Scaling Means](#1-what-database-scaling-means)
   - [Scaling is not only adding servers](#11-scaling-is-not-only-adding-servers)
   - [The three dimensions of database growth](#12-the-three-dimensions-of-database-growth)
2. [Start by Finding the Actual Bottleneck](#2-start-by-finding-the-actual-bottleneck)
   - [Important metrics](#21-important-metrics)
   - [Typical symptoms and likely causes](#22-typical-symptoms-and-likely-causes)
3. [The Database Scaling Ladder](#3-the-database-scaling-ladder)
4. [Step 1: Improve the Existing Database](#4-step-1-improve-the-existing-database)
   - [Indexes](#41-indexes)
   - [Query optimization](#42-query-optimization)
   - [Schema and data-access improvements](#43-schema-and-data-access-improvements)
   - [Batching and asynchronous work](#44-batching-and-asynchronous-work)
5. [Step 2: Scale Vertically](#5-step-2-scale-vertically)
6. [Step 3: Manage Connections](#6-step-3-manage-connections)
   - [Why connections become a bottleneck](#61-why-connections-become-a-bottleneck)
   - [Connection pooling](#62-connection-pooling)
7. [Step 4: Add Caching](#7-step-4-add-caching)
   - [Cache-aside flow](#71-cache-aside-flow)
   - [Cache invalidation](#72-cache-invalidation)
   - [Stampede protection](#73-stampede-protection)
8. [Step 5: Scale Reads with Replicas](#8-step-5-scale-reads-with-replicas)
   - [Primary-replica architecture](#81-primary-replica-architecture)
   - [Replication lag and consistency](#82-replication-lag-and-consistency)
   - [Read-routing strategies](#83-read-routing-strategies)
9. [High Availability Is Different from Read Scaling](#9-high-availability-is-different-from-read-scaling)
10. [Step 6: Partition Large Tables](#10-step-6-partition-large-tables)
    - [Common partitioning strategies](#101-common-partitioning-strategies)
    - [Partition pruning](#102-partition-pruning)
    - [Partitioning is not sharding](#103-partitioning-is-not-sharding)
11. [Step 7: Shard the Database](#11-step-7-shard-the-database)
    - [How sharding works](#111-how-sharding-works)
    - [Choosing a shard key](#112-choosing-a-shard-key)
    - [Shard-routing approaches](#113-shard-routing-approaches)
    - [Cross-shard operations](#114-cross-shard-operations)
    - [Resharding](#115-resharding)
12. [Functional Partitioning and Service-Owned Databases](#12-functional-partitioning-and-service-owned-databases)
13. [Scaling Writes](#13-scaling-writes)
    - [Reduce unnecessary writes](#131-reduce-unnecessary-writes)
    - [Queue and batch writes](#132-queue-and-batch-writes)
    - [Separate transactional and analytical workloads](#133-separate-transactional-and-analytical-workloads)
14. [Denormalization, CQRS, and Materialized Views](#14-denormalization-cqrs-and-materialized-views)
15. [Multi-Region Database Scaling](#15-multi-region-database-scaling)
16. [SQL vs NoSQL for Scaling](#16-sql-vs-nosql-for-scaling)
17. [Consistency Decisions During Scaling](#17-consistency-decisions-during-scaling)
18. [Practical Architecture Evolution](#18-practical-architecture-evolution)
19. [Example: Scaling an E-Commerce Database](#19-example-scaling-an-e-commerce-database)
