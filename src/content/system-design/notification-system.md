...
2. [Requirements](#2-requirements)
   ...
   - [Out of Scope](#23-out-of-scope)
3. [Core Concepts](#3-core-concepts)
   - [Notification, Message, and Delivery Attempt](#31-notification-message-and-delivery-attempt)
   - [Transactional vs Promotional Notifications](#32-transactional-vs-promotional-notifications)
   - [Push vs Pull Channels](#33-push-vs-pull-channels)
4. [High-Level Architecture](#4-high-level-architecture)
5. [End-to-End Notification Flow](#5-end-to-end-notification-flow)
6. [Major Components](#6-major-components)
   - [Notification API](#61-notification-api)
   - [Event Ingestion](#62-event-ingestion)
   - [Orchestrator](#63-orchestrator)
   - [Preference Service](#64-preference-service)
   - [Template Service](#65-template-service)
   - [Scheduling Service](#66-scheduling-service)
   - [Channel Queues](#67-channel-queues)
   - [Channel Workers](#68-channel-workers)
   - [Provider Adapters](#69-provider-adapters)
   - [Webhook and Delivery-Receipt Service](#610-webhook-and-delivery-receipt-service)
   - [Notification Inbox](#611-notification-inbox)
7. [Data Model](#7-data-model)
8. [API Design](#8-api-design)
9. [Notification State Machine](#9-notification-state-machine)
10. [Reliability and Delivery Guarantees](#10-reliability-and-delivery-guarantees)
    - [At-Least-Once Delivery](#101-at-least-once-delivery)
    - [Idempotency](#102-idempotency)
    - [Transactional Outbox](#103-transactional-outbox)
    - [Retries and Exponential Backoff](#104-retries-and-exponential-backoff)
    - [Dead-Letter Queues](#105-dead-letter-queues)
    - [Provider Failover](#106-provider-failover)
11. [User Preferences and Consent](#11-user-preferences-and-consent)
12. [Template Design](#12-template-design)
13. [Scheduling, Batching, and Digests](#13-scheduling-batching-and-digests)
14. [Priority and Rate Limiting](#14-priority-and-rate-limiting)
15. [Ordering and Deduplication](#15-ordering-and-deduplication)
16. [Scaling the System](#16-scaling-the-system)
    - [Capacity Estimation](#161-capacity-estimation)
    - [Partitioning Strategy](#162-partitioning-strategy)
    - [Handling Traffic Spikes](#163-handling-traffic-spikes)
17. [Failure Scenarios](#17-failure-scenarios)
18. [Observability](#18-observability)
19. [Security and Privacy](#19-security-and-privacy)
20. [Channel-Specific Considerations](#20-channel-specific-considerations)
21. [Multi-Tenant Design](#21-multi-tenant-design)
22. [Deployment Architecture](#22-deployment-architecture)
23. [Technology Choices](#23-technology-choices)
24. [Design Trade-offs](#24-design-trade-offs)
25. [Practical Example: Order Shipment Notification](#25-practical-example-order-shipment-notification)
26. [Evolution from MVP to Large Scale](#26-evolution-from-mvp-to-large-scale)
27. [Interview Discussion Summary](#27-interview-discussion-summary)
